...
interface AiConfigRow {
  ...
  agent_deal_pipeline_id: string | null
  agent_deal_stage_id: string | null
}

const CONFIG_COLUMNS =
  'provider, model, api_key, system_prompt, is_active, auto_reply_enabled, auto_reply_max_per_conversation, handoff_agent_id, embeddings_api_key, agent_url, handoff_timeout_hours, agent_deal_pipeline_id, agent_deal_stage_id'
...
export async function loadAiConfig(
  ...
  return {
    ...
    handoffTimeoutHours: row.handoff_timeout_hours ?? null,
    dealPipelineId: row.agent_deal_pipeline_id ?? null,
    dealStageId: row.agent_deal_stage_id ?? null,
  }
}
